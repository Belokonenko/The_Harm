export default function work() {
    const imgItem = document.querySelectorAll('.work__list-img-item')
    ...
    imgItem.forEach((item, i) => {
        imgItem[i].addEventListener('mouseenter', () => {
            console.log('mouseenter')
                    imgItem[i].append(div);
        })

        imgItem[i].addEventListener('mouseleave', () => {
